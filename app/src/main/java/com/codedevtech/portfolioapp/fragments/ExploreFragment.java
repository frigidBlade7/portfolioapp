...
public class ExploreFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        DashboardFragmentViewModel dashboardFragmentViewModel = new ViewModelProvider(getParentFragment().getParentFragment().getParentFragment(), viewModelFactory).get(DashboardFragmentViewModel.class);
